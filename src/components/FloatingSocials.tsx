export default function FloatingSocials() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col space-y-3 md:space-y-4">
      ...
      <a
        ...
        className="relative w-12 h-12 md:w-14 md:h-14 rounded-full text-white shadow-[0_4px_12px_rgba(0,0,0,0.15)] flex items-center justify-center hover:scale-110 hover:shadow-[0_8px_16px_rgba(0,0,0,0.2)] transition-all duration-200"
        style={{
          background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)'
        }}
      >
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6 md:w-7 md:h-7" aria-hidden="true">
      ...
      <a
        ...
        className="relative w-12 h-12 md:w-14 md:h-14 rounded-full text-white bg-[#25D366] shadow-[0_4px_12px_rgba(0,0,0,0.15)] flex items-center justify-center hover:scale-110 hover:shadow-[0_8px_16px_rgba(0,0,0,0.2)] transition-all duration-200"
      >
        {/* Pulse effect */}
